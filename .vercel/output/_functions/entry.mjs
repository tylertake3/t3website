...
var middlewareSecret = "31b70d59-9e0e-4aa6-888a-c3196ffed809";
//#endregion
...
var _page0 = () => import("./chunks/generic_BXqvdT5Q.mjs").then((n) => n.t);
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SSR": true
		}, { _: "/Users/tylerkennington/.odyn/take3-website/worktrees/9y0m-valknut/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": "https://www.take3agency.com",
			"SSR": true
		}, { _: "/Users/tylerkennington/.odyn/take3-website/worktrees/9y0m-valknut/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "31b70d59-9e0e-4aa6-888a-c3196ffed809") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
