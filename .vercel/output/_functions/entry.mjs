...
var middlewareSecret = "37bef511-c441-436b-aa4f-281c354519f2";
//#endregion
...
var _page0 = () => import("./chunks/generic_Ba9Anmax.mjs").then((n) => n.t);
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SSR": true
		}, { _: "/Users/tylerkennington/.odyn/take3-website/worktrees/ci2e-lindworm/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": "https://www.take3agency.com",
			"SSR": true
		}, { _: "/Users/tylerkennington/.odyn/take3-website/worktrees/ci2e-lindworm/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "37bef511-c441-436b-aa4f-281c354519f2") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
