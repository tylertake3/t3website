...
var middlewareSecret = "e36f0587-1627-4387-95ca-d196817a1e57";
//#endregion
...
var _page0 = () => import("./chunks/generic_CR9aBPAT.mjs").then((n) => n.t);
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SSR": true
		}, { _: "/Users/tylerkennington/.odyn/take3-website/worktrees/zed2-sessrumnir/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": "https://www.take3agency.com",
			"SSR": true
		}, { _: "/Users/tylerkennington/.odyn/take3-website/worktrees/zed2-sessrumnir/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "e36f0587-1627-4387-95ca-d196817a1e57") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
