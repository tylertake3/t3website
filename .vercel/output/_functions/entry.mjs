...
var middlewareSecret = "8b2fc62b-cb59-477b-9235-ed50a1e44758";
//#endregion
...
var _page0 = () => import("./chunks/generic_CTLMVN3K.mjs").then((n) => n.t);
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SSR": true
		}, { _: "/Users/tylerkennington/.odyn/take3-website/worktrees/lnu8-myrkvidr/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": "https://www.take3agency.com",
			"SSR": true
		}, { _: "/Users/tylerkennington/.odyn/take3-website/worktrees/lnu8-myrkvidr/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "8b2fc62b-cb59-477b-9235-ed50a1e44758") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
