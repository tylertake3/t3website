...
var middlewareSecret = "6af8f7c9-5d7a-41f0-a640-cba2793667c8";
//#endregion
...
var _page0 = () => import("./chunks/generic_DI0obHw0.mjs").then((n) => n.t);
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SSR": true
		}, { _: "/Users/tylerkennington/.odyn/take3-website/worktrees/u9lu-skofnung/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": "https://www.take3agency.com",
			"SSR": true
		}, { _: "/Users/tylerkennington/.odyn/take3-website/worktrees/u9lu-skofnung/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "6af8f7c9-5d7a-41f0-a640-cba2793667c8") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
