...
import { A as clientAddressSymbol, C as isRoute404, D as DEFAULT_404_COMPONENT, E as ASTRO_GENERATOR, F as decryptString, I as generateCspDigest, M as originPathnameSymbol, N as responseSentSymbol$1, O as REDIRECT_STATUS_CODES, P as decodeKey, T as ASTRO_ERROR_HEADER, _ as pushDirective, a as renderPage, c as chunkToString, d as isRenderTemplateResult, f as renderTemplate, g as normalizeCspResourceEntry, h as isRenderInstruction, j as fetchStateSymbol, k as REROUTABLE_STATUS_CODES, l as createSlotValueFromString, n as AstroIntegrationLogger, o as renderJSX, r as astroToRuntimeLogger, s as renderComponent, t as createConsoleLogger, u as renderSlotToString, v as isAstroComponentFactory, w as isRoute500, x as renderEndpoint, y as markHTMLString } from "./chunks/console_D6lw_DWn.mjs";
...
var middlewareSecret = "0f85692d-7bd5-42c0-941b-e2680a296cc7";
//#endregion
...
var _page0 = () => import("./chunks/generic_D8SfG5Ic.mjs").then((n) => n.t);
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SSR": true
		}, { _: "/Users/tylerkennington/.odyn/take3-website/worktrees/ctr4-vingolf/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": "https://www.take3agency.com",
			"SSR": true
		}, { _: "/Users/tylerkennington/.odyn/take3-website/worktrees/ctr4-vingolf/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "0f85692d-7bd5-42c0-941b-e2680a296cc7") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
