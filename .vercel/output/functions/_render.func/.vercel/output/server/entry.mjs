...
var middlewareSecret = "1bc2db4c-61ad-4865-92d4-2e0a262ca57c";
//#endregion
...
var _page0 = () => import("./chunks/generic_CVjM7KR9.mjs").then((n) => n.t);
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SSR": true
		}, { _: "/Users/tylerkennington/.odyn/take3-website/worktrees/hmfy-fensalir/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": "https://www.take3agency.com",
			"SSR": true
		}, { _: "/Users/tylerkennington/.odyn/take3-website/worktrees/hmfy-fensalir/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "1bc2db4c-61ad-4865-92d4-2e0a262ca57c") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
