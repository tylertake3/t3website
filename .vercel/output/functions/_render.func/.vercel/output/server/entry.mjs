...
var middlewareSecret = "ab035542-4290-4e62-ba56-46add6389c20";
//#endregion
...
var _page0 = () => import("./chunks/generic_1Ptqx1xN.mjs").then((n) => n.t);
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SSR": true
		}, { _: "/Users/tylerkennington/.odyn/take3-website/worktrees/2ujm-gulltopp/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": "https://www.take3agency.com",
			"SSR": true
		}, { _: "/Users/tylerkennington/.odyn/take3-website/worktrees/2ujm-gulltopp/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "ab035542-4290-4e62-ba56-46add6389c20") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
