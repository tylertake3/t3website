...
var middlewareSecret = "4176dc00-566f-4ffc-ac74-b5788c89fda7";
//#endregion
...
var _page0 = () => import("./chunks/generic_DkL2HycN.mjs").then((n) => n.t);
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SSR": true
		}, { _: "/Users/tylerkennington/.odyn/take3-website/worktrees/bvnp-andhrimnir/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": "https://www.take3agency.com",
			"SSR": true
		}, { _: "/Users/tylerkennington/.odyn/take3-website/worktrees/bvnp-andhrimnir/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "4176dc00-566f-4ffc-ac74-b5788c89fda7") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
